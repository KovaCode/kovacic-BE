...
public class UserTest2 extends AbstractTestNGSpringContextTests {
    ...
    public void testCreateUser(){
        ...
        System.err.println("User successfully saved ("+ response.getBody().getFirstName() + " "  + response.getBody().getLastName() + ")");
